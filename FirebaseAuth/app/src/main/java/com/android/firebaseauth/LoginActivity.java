    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    // User is signed in
                    Log.d(TAG, getString(R.string.signed_in_txt) + user.getUid());

                } else {
                    // User is signed out
                    Log.d(TAG, getString(R.string.sigend_out_txt));
                }
                // ...
            }
        };
        ...
        if (isEmailValid(email) && isPasswordValid(password)) {
            mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    Log.d(TAG, "sigInWithEmail:onComplete: " + task.isSuccessful());
                    if (!task.isSuccessful()) {
                        Log.w(TAG, "signInWithEmail:failed", task.getException());
                        Toast.makeText(LoginActivity.this, R.string.auth_failed_txt, Toast.LENGTH_LONG).show();
                        showProgress(false);
                    } else {
                        Log.d(TAG, "signInWithEmail:success");
                        Toast.makeText(LoginActivity.this, R.string.auth_success_txt, Toast.LENGTH_LONG).show();
